...
while(True):
    ...
    # show video stream
    cv2.putText(gray, "N - Neutral", (10, 15),cv2.FONT_HERSHEY_SIMPLEX, 0.45,(0,0,0), 1)
    cv2.putText(gray, "H - Happy", (10, 35),cv2.FONT_HERSHEY_SIMPLEX, 0.45,(0,0,0), 1)
    cv2.putText(gray, "S - Sad", (10, 55),cv2.FONT_HERSHEY_SIMPLEX, 0.45,(0,0,0), 1)
    cv2.putText(gray, "Q - Quit", (10, 75),cv2.FONT_HERSHEY_SIMPLEX, 0.45,(0,0,0), 1)
    cv2.putText(gray, "A - Angry", (10, 95),cv2.FONT_HERSHEY_SIMPLEX, 0.45,(0,0,0), 1)
